...
/** @beta */
export declare type AgentCallbacks = {
 ...
 */
export declare type AgentMood = 'excited' | 'happy' | 'playful' | 'curious' | 'surprised' | 'hopeful' | 'empathetic' | 'sad' | 'angry' | 'anxious' | 'calm';
...
declare type AgentSdkStates = 'initializing' | 'idle' | 'listening' | 'thinking' | 'speaking';
 ...
 * @beta
 * */
export declare type AgentState = 'disconnected' | 'connecting' | 'pre-connect-buffering' | 'failed' | AgentSdkStates;

declare type AgentStateAvailable = AgentStateCommon & {
...
declare type AgentStateCases = AgentStateConnecting | AgentStateDisconnected | AgentStateAvailable | AgentStatePreConnectBuffering | AgentStateUnAvailable | AgentStateFailed;

declare type AgentStateCommon = {
    attributes: Participant['attributes'];
    internal: {
        emitter: default_2<AgentCallbacks>;
        agentParticipant: RemoteParticipant | null;
        workerParticipant: RemoteParticipant | null;
    };
};

declare type AgentStateConnecting = AgentStateCommon & {
    state: 'connecting';
    failureReasons: null;
...
declare type AgentStateDisconnected = AgentStateCommon & {
    state: 'disconnected';
    failureReasons: null;
    /** The client's assigned identity, coming from the JWT token. */
    identity: undefined;
...
declare type AgentStateFailed = AgentStateCommon & {
    state: 'failed';
...
declare type AgentStatePreConnectBuffering = AgentStateCommon & {
...
/** @internal */
export declare function isUseSessionReturn(value: unknown): value is UseSessionReturn;
...
/** @beta */
export declare type MessagesCallbacks = {
 ...
 * @public
 */
export declare function RoomAudioRenderer({ room, volume, muted }: RoomAudioRendererProps): React_2.JSX.Element;
 ...
 * @beta
 */
export declare type RpcCallParams<Payload> = Omit<PerformRpcParams, 'payload'> & {
    payload: Payload;
};

/** @beta */
export declare type RpcHandler<Input = any, Output = any> = (payload: Input, data: RpcInvocationData) => Promise<Output>;

/** @beta */
export declare type RpcPerformFn = {
...
/** @beta */
export declare type SessionCallbacks = {
...
/** @beta */
export declare type SessionConnectOptions = {
 ...
 * @beta
 */
export declare function SessionProvider(props: SessionProviderProps): React_2.JSX.Element;
...
declare type SessionStateCommon = {
    room: Room;
    internal: {
        emitter: default_2<SessionCallbacks>;
...
declare type SessionStateConnected = SessionStateCommon & {
    connectionState: ConnectionState_2.Connected | ConnectionState_2.Reconnecting | ConnectionState_2.SignalReconnecting;
    isConnected: true;
    local: {
        cameraTrack?: TrackReference;
        microphoneTrack?: TrackReference;
...
declare type SessionStateConnecting = SessionStateCommon & {
    connectionState: ConnectionState_2.Connecting;
    isConnected: false;
    local: {
        cameraTrack: undefined;
        microphoneTrack: undefined;
...
declare type SessionStateDisconnected = SessionStateCommon & {
    connectionState: ConnectionState_2.Disconnected;
    isConnected: false;
    local: {
        cameraTrack: undefined;
        microphoneTrack: undefined;
...
declare type SessionStub = Pick<UseSessionReturn, 'connectionState' | 'room' | 'internal'>;
...
/** @beta */
export declare type SwitchActiveDeviceOptions = {
    /**
 ...
 * @beta
 */
export declare interface UseAgentExpressionOptions extends UseTranscriptionsOptions {
    /**
 ...
 * @beta
 */
export declare interface UseAgentExpressionReturn {
...
/** @beta */
export declare type UseAgentReturn = AgentStateCases & AgentActions;
...
/** @public */
export declare function useEvents<Emitter extends default_2<EventMap>, EmitterEventMap extends (Emitter extends default_2<infer EM> ? EM : never), Event extends Parameters<Emitter['on']>[0], Callback extends EmitterEventMap[Event]>(instance: Emitter | {
    internal: {
        emitter: Emitter;
    };
...
declare type UseParticipantTracksOptions = {
 ...
 * @beta
 */
export declare function useRpc<S extends Serializer<any, any>>(session: UseSessionReturn, methodName: string, handler: RpcHandler<SerializerInput<S>, SerializerOutput<S>>, options?: UseRpcOptions<S>): UseRpcReturn;

/** @beta */
export declare function useRpc<S extends Serializer<any, any>>(methodName: string, handler: RpcHandler<SerializerInput<S>, SerializerOutput<S>>, options?: UseRpcOptions<S>): UseRpcReturn;

/** @beta */
export declare function useRpc(session: UseSessionReturn): UseRpcReturn;

/** @beta */
export declare function useRpc(): UseRpcReturn;

/**
 * Options for {@link (useRpc:1)}.
 * @beta
 */
export declare type UseRpcOptions<S extends Serializer<any, any> = Serializer<any, any>> = {
...
/** @beta */
export declare type UseRpcReturn = {
...
/** @public */
export declare type UseSequentialRoomConnectDisconnectResults<R extends Room | undefined> = {
...
declare type UseSessionCommonOptions = {
    /**
...
declare type UseSessionConfigurableOptions = UseSessionCommonOptions & UseSessionRoomOptions & TokenSourceFetchOptions;
...
declare type UseSessionEncryptionOptions = {
    /**
...
declare type UseSessionFixedOptions = UseSessionCommonOptions & UseSessionRoomOptions;

/** @beta */
export declare function useSessionMessages(session?: UseSessionReturn): UseSessionMessagesReturn;

/** @beta */
export declare type UseSessionMessagesReturn = {
...
/** @beta */
export declare type UseSessionReturn = (SessionStateConnecting | SessionStateConnected | SessionStateDisconnected) & SessionActions;

declare type UseSessionRoomOptions = UseSessionWithRoomOptions | UseSessionWithoutRoomOptions;

declare type UseSessionWithoutRoomOptions = {
    room?: never;
    /** Configuration for room-level E2EE */
    encryption?: UseSessionEncryptionOptions;
};

declare type UseSessionWithRoomOptions = {
    room: Room;
    encryption?: never;
};
 ...
 * @public
 */
export declare function useSpeakingParticipants(options?: UseSpeakingParticipantsOptions): Participant[];

/** @public */
export declare type UseSpeakingParticipantsOptions = {
    room?: Room;
};
...
/** @beta */
export declare type UseTextStreamOptions = {
    room?: Room;
};
