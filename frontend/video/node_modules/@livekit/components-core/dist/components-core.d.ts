...
export declare function createDataObserver(room: Room): Observable<[payload: Uint8Array<ArrayBuffer>, participant?: RemoteParticipant | undefined, kind?: DataPacket_Kind | undefined, topic?: string | undefined, encryptionType?: Encryption_Type | undefined]>;
...
export declare type ReceivedAgentTranscriptionMessage = ReceivedMessageWithType<'agentTranscript', {
    message: string;
}>;

/** @public */
export declare type ReceivedChatMessage = Omit<ReceivedChatMessageWithRequiredType, 'type'> & {
    type?: 'chatMessage';
};

/** @private */
declare type ReceivedChatMessageWithRequiredType = ReceivedMessageWithType<'chatMessage', ChatMessage & {
    from?: Participant;
...
/** @beta */
export declare type ReceivedMessage = ReceivedUserTranscriptionMessage | ReceivedAgentTranscriptionMessage | ReceivedChatMessage;

declare type ReceivedMessageWithType<Type extends string, Metadata extends object = object> = {
    id: string;
    timestamp: number;
    type: Type;
    from?: Participant;
...
export declare type ReceivedUserTranscriptionMessage = ReceivedMessageWithType<'userTranscript', {
    message: string;
}>;
...
export declare type SentMessage = ChatMessage;
